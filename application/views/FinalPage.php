                    ...
                    <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <?php 
                                $no=1;
                                foreach ($finalpage as $s){ ?>
                                    <tr>
                                        <td><?php echo $s['id']; ?></td>
                                        <td><?php echo $s['kodenegara']; ?></td>
                                        <td style="width: 60%"><?php echo $s['namanegara']; ?></td>
                                        <td><div style="margin-left: 20%;">
                                            <a href="<?php echo site_url('CC/FinalAlgoritma/'.$s['kodenegara'])?>"><button type="submit" class="btn btn-success btn-sm" >
                                                <i class="fa fa-refresh"></i>  Final
                                            </button></a></div>
                                        </td>
                                    </tr>
